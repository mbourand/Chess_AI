...
*/
constexpr std::array<uint64_t, 781> ZOBRIST_KEYS = {
...
constexpr std::array<uint64_t, 64> ROOK_BEHIND_PAWN_MASKS = {
    72340172838076672ULL, 144680345676153344ULL, 289360691352306688ULL, 578721382704613376ULL, 1157442765409226752ULL, 2314885530818453504ULL, 4629771061636907008ULL, 9259542123273814016ULL,
    72340172838076416ULL, 144680345676152832ULL, 289360691352305664ULL, 578721382704611328ULL, 1157442765409222656ULL, 2314885530818445312ULL, 4629771061636890624ULL, 9259542123273781248ULL,
    72340172838010880ULL, 144680345676021760ULL, 289360691352043520ULL, 578721382704087040ULL, 1157442765408174080ULL, 2314885530816348160ULL, 4629771061632696320ULL, 9259542123265392640ULL,
    72340172821233664ULL, 144680345642467328ULL, 289360691284934656ULL, 578721382569869312ULL, 1157442765139738624ULL, 2314885530279477248ULL, 4629771060558954496ULL, 9259542121117908992ULL,
    72340168526266368ULL, 144680337052532736ULL, 289360674105065472ULL, 578721348210130944ULL, 1157442696420261888ULL, 2314885392840523776ULL, 4629770785681047552ULL, 9259541571362095104ULL,
    72339069014638592ULL, 144678138029277184ULL, 289356276058554368ULL, 578712552117108736ULL, 1157425104234217472ULL, 2314850208468434944ULL, 4629700416936869888ULL, 9259400833873739776ULL,
...
constexpr int PASSED_PAWN_VALUE = 20;
constexpr int ROOK_BEHIND_PASSED_PAWN_VALUE = 10;
...
constexpr std::array<int, 64> KING_TABLE_MIDDLEGAME = {
...
constexpr std::array<std::array<int, 64>, 7> PIECE_TABLES = {
...
class Computer
{
    public:
        ...
        std::vector<std::array<uint16_t, 2>> m_killerMoves;
        uint64_t m_timeToPlay;

        Computer();
        Computer(const Computer& other);
        Computer(uint8_t depth, const std::string& openingBook);
    ...
    private:
        ...
        int quiescence(BitBoard& board, int alpha, int beta, int8_t color);
